...
inline QString PassportCorrupted() {
	return u"It seems your Teamgram Passport data was corrupted.\n\nYou can reset your Teamgram Passport and restart this authorization."_q;
}

inline QString PassportCorruptedChange() {
	return u"It seems your Teamgram Passport data was corrupted.\n\nYou can reset your Teamgram Passport and change your cloud password."_q;
}
...
inline QString PassportCorruptedResetSure() {
	return u"Are you sure you want to reset your Teamgram Passport data?"_q;
}
